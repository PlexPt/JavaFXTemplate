...
import net.w2p.appfx.ui.*;
import net.w2p.appfx.views.LoginController;
...
public class SideMenuController {
    ...
    public void init() {
        ...
        bindNodeToController(lbl_login, LoginController.class, contentFlow, contentFlowHandler);
    }

...
public class SmoothedChart<X, Y> extends AreaChart<X, Y> {
    ...
    public void setSymbolsVisible(final Series<X, Y> SERIES, final boolean VISIBLE) {
    ...
    public void setSeriesColor(final Series<X, Y> SERIES, final Paint COLOR) {
    ...
    public void setSeriesColor(final Series<X, Y> SERIES, final Paint STROKE, final Paint FILL) {
    ...
    public void setSeriesColor(final Series<X, Y> SERIES, final Paint STROKE, final Paint FILL, final Paint LEGEND_SYMBOL_FILL) {
        Background symbolBackground = new Background(new BackgroundFill(STROKE, new CornerRadii(1024), Insets.EMPTY), new BackgroundFill(Color.WHITE, new CornerRadii(1024), new Insets(2)));
        setSeriesColor(SERIES, STROKE, FILL, symbolBackground, LEGEND_SYMBOL_FILL);
    }
    public void setSeriesColor(final Series<X, Y> SERIES, final Paint STROKE, final Paint FILL, final Background SYMBOL_BACKGROUND) {
        setSeriesColor(SERIES, STROKE, FILL, SYMBOL_BACKGROUND, STROKE);
    }
    public void setSeriesColor(final Series<X, Y> SERIES, final Paint STROKE, final Paint FILL, final BackgroundFill SYMBOL_STROKE, final BackgroundFill SYMBOL_Fill) {
        setSeriesColor(SERIES, STROKE, FILL, new Background(SYMBOL_STROKE, SYMBOL_Fill), STROKE);
    }
    public void setSeriesColor(final Series<X, Y> SERIES, final Paint STROKE, final Paint FILL, final Background SYMBOL_BACKGROUND, final Paint LEGEND_SYMBOL_FILL) {
